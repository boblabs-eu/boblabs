...
class OrchestratorSettings(Base):
    ...
    orchestrator_model: Mapped[str] = mapped_column(
        String(255), default="qwen2.5:72b"
    )
    ...
    artifact_storage_path: Mapped[str] = mapped_column(
        String(500), default="/data/artifacts"
    )
...
class GpuLock(Base):
    ...
    __table_args__ = (
        UniqueConstraint("server_id", "gpu_index", name="uq_gpu_lock"),
    )
...
class CronJob(Base):
    ...
    method: Mapped[str] = mapped_column(
        String(30), default="orchestrator_inject", server_default="orchestrator_inject",
...
class PromptTemplate(Base):
    ...
    target: Mapped[str] = mapped_column(
        String(20), default="agent", server_default="agent",
...
class Lab(Base):
    ...
    # Loop strategy
    loop_type: Mapped[str] = mapped_column(String(50), default="plan_execute", server_default="plan_execute")
    ...
    orchestrator_temperature: Mapped[Decimal] = mapped_column(Numeric(3, 2), default=Decimal("0.70"))
    ...
    orchestrator_tool_set_ids: Mapped[list] = mapped_column(JSONB, default=list, server_default="[]")
    ...
    tool_container_memory_mb: Mapped[int] = mapped_column(Integer, default=512, server_default="512")
...
class LabTool(Base):
    ...
    execution_side: Mapped[str] = mapped_column(String(10), default="server", server_default="server")
...
class LabMessage(Base):
    ...
    content: Mapped[str] = mapped_column(Text, nullable=False)
    message_type: Mapped[str] = mapped_column(String(20), default="message", server_default="message")
