...
│   │   ├── tool_executor.py        # 34 built-in tools + execution engine
...
Labs provide agents with 34 built-in tools. See [TOOLS_AND_SANDBOX.md](TOOLS_AND_SANDBOX.md) for the complete reference.
